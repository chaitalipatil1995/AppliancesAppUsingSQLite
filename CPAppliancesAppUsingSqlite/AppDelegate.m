...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *sourcePath = [[NSBundle mainBundle]pathForResource:@"CPSTANDAEDDATABASE" ofType:@"sqlite"];
    
    NSString *destionationPath = [NSHomeDirectory() stringByAppendingPathComponent:@"Documents/SqLDatabase.sqlite"];
    ...
    //    NSLog(@"%@",[[ATDatabaseManager sharedManager]getDatabasePath]);
